          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                onChange={handleChange}
                required
                placeholder="no-man-is-an-island"
                className="flex-1 px-3 py-2.5 bg-zinc-950 border border-zinc-800 rounded-lg text-zinc-100 text-sm focus:outline-none focus:border-zinc-600 font-mono"
              />
              <button
                type="button"
                onClick={generateSlug}
                className="px-3 py-2.5 text-xs text-zinc-400 border border-zinc-800 rounded-lg hover:text-zinc-100 hover:border-zinc-600 transition-colors"
              >
                자동 생성
              </button>
            </div>
